...
namespace io {
  ...
  pros::Motor RollerL(4, MOTOR_GEARSET_18, 0, MOTOR_ENCODER_ROTATIONS);//left roller
  pros::Motor RollerR(5, MOTOR_GEARSET_18, 1, MOTOR_ENCODER_ROTATIONS);//right roller
