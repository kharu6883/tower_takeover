...
void skills2() {
  ...
  delay(200);
  chassis.lock();
  chassis.withPoint({50, 0}, 45, 1)
           .withPoint({650, -550}, 45, 5)
  ...
  arm.waitUntilSettled();
   ...
   chassis.lock();
   chassis.waitUntilSettled();
   chassis.turn({1671, -205},100,5).withTol(20).waitUntilSettled();
   chassis.withPoint({1500, -205}, 65, 12)
            .withPoint({3165, -205}, 70, 12)
            .withPoint({4350, -195}, 50, 12)
