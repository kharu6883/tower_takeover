...
void skills3() {
  ...
  arm.waitUntilSettled();
   ...
   chassis.drive(2300, 60, 10).withGyro(180).withTol(6).waitUntilSettled();
   delay(500);
   arm.tower(2);
   chassis.turn(225, 127,4).withTol(4).withoutOdom().waitUntilSettled();
   chassis.drive(400, 80, 10).withGyro(225).withTol(6).waitUntilSettled();
  roller(-90);
  delay(200);
  chassis.drive(-600, 80, 10).withGyro(225).withTol(6).waitUntilSettled();
  arm.zero();
  roller(127);
  chassis.turn(270, 127,4).withTol(4).withoutOdom().waitUntilSettled();
  chassis.drive(1000, 80, 10).withGyro(270).withTol(6).waitUntilSettled();
  chassis.drive(1500, 80, 10).withGyro(235).withTol(6).waitUntilSettled();
  chassis.drive(400, 80, 1,4).withGyro(270).withTol(6).waitUntilSettled();
  LF.move(-127);
  LB.move(127);
  RF.move(-127);
  RB.move(127);
  ...
  roller(-70);
  chassis.lock();
  chassis.drive(-400, 90, 5).withTol(60).waitUntilSettled();
  chassis.strafe(1280, 75).withSlop(-580).withTol(20).waitUntilSettled();
  chassis.left(-70);
  chassis.right(-70);
  chassis.lock();
  delay(400);
  roller(127);
  chassis.drive(1900, 85, 10).withGyro(0).withTol(12).waitUntilSettled();
  delay(100);
  arm.tower(1);
  delay(400);
  chassis.turn(325, 50,4).withTol(4).withoutOdom().waitUntilSettled();
  chassis.drive(200, 50).withGyro(325).withConst(0.6, 0.2).withTol(4).waitUntilSettled();
  roller(-80);
  delay(400);
  roller(127);
  chassis.lock();
  chassis.drive(-150, 50).withGyro(325).withConst(0.4, 0.2).withTol(5).waitUntilSettled();
  arm.zero();
  delay(200);
  chassis.turn(0, 55,4).withoutOdom().withTol(6).waitUntilSettled();
  chassis.drive(2600, 80, 10).withGyro(0).withTol(6).waitUntilSettled();
