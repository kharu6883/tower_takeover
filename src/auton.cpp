...
roller(127);
    ...
    roller(127);
    chassis.turn({1300,-1000}, 127,8).withTol(10).waitUntilSettled();
    chassis.drive({1500,-1000}, 50,6).withTol(100).drive().waitUntilSettled();
...
void bluesmallzone7() {
  ...
  roller(127);
  chassis.turn({1300,1000}, 127,8).withTol(10).waitUntilSettled();
  chassis.drive({1500,1000}, 50,6).withTol(200).waitUntilSettled();
...
void skills2() {
  ...
  arm.waitUntilSettled();
   ...
   chassis.strafe(-2600, 127).withSlop(0).withTol(20).waitUntilSettled();
