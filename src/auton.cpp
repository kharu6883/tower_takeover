...
void redsmallzone11() {
  ...
  roller(0);
  chassis.waitUntilSettled();
  chassis.turn(135,70,4).withoutOdom().withTol(4).waitUntilSettled();
}
...
void redbigzonescore() {
  ...
  delay(800);
    ...
    roller(-70);
    chassis.lock();
    chassis.drive(-350,127,2).withGain(0.2).withTol(50).waitUntilSettled();
}
...
void bluesmallzone11() {
  ...
  arm.zero();
  delay(200);
  chassis.drive(-1350,110,6,2).withGyro(70).withTol(10).waitUntilSettled();
  chassis.turn(0,127,4).withoutOdom().withTol(4).waitUntilSettled();
  chassis.drive(1400,60,5).withGyro(0).withTol(10).waitUntilSettled();
  chassis.drive(500,40,5).withGyro(0).withTol(10).waitUntilSettled();
  chassis.drive(-650,80,5).withGyro(355).withTol(10).waitUntilSettled();
  chassis.drive(300,40,1,5).withGyro(45).withTol(10).waitUntilSettled();
  chassis.drive(-1000,127,5).withGyro(0).withTol(10);
  delay(200);
  roller(0);
  chassis.waitUntilSettled();
  chassis.turn(225,70,4).withoutOdom().withTol(4).waitUntilSettled();
}
...
void bluesmallzone7() {
      ...
      delay(800);
        ...
        chassis.waitUntilSettled();
      chassis.drive(600,55,5).withGyro(0).withTol(10).waitUntilSettled();
      chassis.drive(-1250,127,5,2).withGyro(75).withTol(10).waitUntilSettled();
      chassis.turn(0,127,4).withoutOdom().withTol(4).waitUntilSettled();
      chassis.drive(1300,60,5).withGyro(0).withTol(10).waitUntilSettled();
      rack.move(1100,127).withTol(0);
...
void skills1() {
    ...
    arm.move(1.05, 127);
    chassis.lock();
    chassis.drive(850,80,4).withGyro(45).withGain(0.2).withTol(50).waitUntilSettled();

    arm.waitUntilSettled();
     roller(-80);
     delay(600);
     roller(127);
     chassis.drive(-680,80,4).withGyro(50).withGain(0.2).withTol(50).waitUntilSettled();
     delay(200);
     ...
     chassis.drive(120, 55).withGyro(90).withGain(0.6, 0.2).withTol(4).waitUntilSettled();
     roller(-80);
     delay(500);
     roller(80);
     chassis.drive(-200, 55).withGyro(90).withGain(0.6, 0.2).withTol(4).waitUntilSettled();
     arm.zero();
     chassis.unlock();
     ...
     chassis.unlock();
     delay(20);
     chassis.drive(300, 127).withGyro(15).withGain(0.8).withTol(60).waitUntilSettled();
     roller(0);
     LF.move(0);
     LB.move(127);
     RF.move(0);
     ...
     chassis.drive(200, 50).withGyro(135).withGain(0.6, 0.2).withTol(4).waitUntilSettled();
     roller(-80);
     delay(500);
     roller(127);
     chassis.lock();
     chassis.drive(-150, 50).withGyro(135).withGain(0.4, 0.2).withTol(5).waitUntilSettled();
     arm.zero();
     delay(200);
     ...
     chassis.strafe(-2700, 127).withSlop(-10).withTol(20).waitUntilSettled();
     ...
     roller(-70);
     chassis.lock();
     chassis.drive(-4040,127,3).withGyro(88).withGain(0.15).withTol(50).waitUntilSettled();
     roller(127);
     LF.move(100);
     LB.move(-100);
     RF.move(100);
     ...
     roller(127);
     chassis.drive(1000,80,2).withGain(0.25).withGyro(90).withTol(50).waitUntilSettled();
     delay(800);
     arm.tower(2);
     delay(700);
     arm.move(1.5, 110);
     delay(400);
     chassis.drive(450,50,2).withGain(0.25).withTol(50).waitUntilSettled();
     roller(-90);
     delay(300);
     chassis.drive(-520,80,2).withGain(0.25).withTol(50).waitUntilSettled();
     delay(300);
     arm.zero();
     roller(127);
     ...
     odom.reset(0);
     roller(127);
     chassis.drive(1150,110,4).withGyro(5).withGain(0.2).withTol(50).waitUntilSettled();
     delay(200);
     arm.tower(1).waitUntilSettled();
     chassis.turn(335,75,4).withoutOdom().withTol(4).waitUntilSettled();
     chassis.drive(200,85,4).withGain(0.8).withTol(50).waitUntilSettled();
     roller(-80);
     delay(400);
     chassis.drive(-300,127,10).withGain(0.8).withTol(50).waitUntilSettled();
     LF.move(0);
     LB.move(0);
     RF.move(0);
     RB.move(0);
...
void skills2() {
      ...
      arm.move(1.05, 127);
      chassis.lock();
      chassis.drive(850,80,4).withGyro(40).withGain(0.2).withTol(50).waitUntilSettled();

      arm.waitUntilSettled();
       roller(-80);
       delay(600);
       roller(127);
       chassis.drive(-650,80,4).withGyro(45).withGain(0.2).withTol(50).waitUntilSettled();
       delay(200);
       arm.zero().waitUntilSettled();
       chassis.waitUntilSettled();
       delay(100);
       ...
       chassis.drive(2300,50,5).withGyro(359).withTol(10).waitUntilSettled();
                ...
                delay(200);
       chassis.turn(90, 75,4).withoutOdom().withTol(4).waitUntilSettled();
       chassis.drive(120, 45).withGyro(90).withGain(0.6, 0.2).withTol(4).waitUntilSettled();
       roller(-80);
       delay(500);
       roller(80);
       chassis.drive(-200, 45).withGyro(90).withGain(0.6, 0.2).withTol(4).waitUntilSettled();
       arm.zero();
       chassis.unlock();
       chassis.turn(15, 75,4).withoutOdom().withTol(4).waitUntilSettled();
       delay(20);
       chassis.unlock();
       delay(20);
       chassis.drive(200, 127).withGyro(15).withGain(0.8).withTol(60).waitUntilSettled();
       roller(0);
       LF.move(0);
       LB.move(127);
       RF.move(0);
       ...
       roller(-70);
       chassis.lock();
       chassis.drive(-4040,127,3).withGain(0.15).withTol(50).waitUntilSettled();
       roller(127);
       LF.move(100);
       LB.move(-100);
       RF.move(100);
       ...
       arm.move(1.5, 110);
       delay(400);
       chassis.drive(480,50,2).withGain(0.25).withTol(50).waitUntilSettled();
       roller(-90);
       delay(300);
       chassis.drive(-550,80,2).withGain(0.25).withTol(50).waitUntilSettled();
       delay(300);
       arm.zero();
       roller(127);
       chassis.turn(5,127,4).withoutOdom().withTol(4).waitUntilSettled();
       odom.reset(0);
       roller(127);
       chassis.drive(1150,80,4).withGyro(5).withGain(0.2).withTol(50).waitUntilSettled();
       delay(200);
       arm.tower(1).waitUntilSettled();
